...
"[project]/frontend/src/config/env.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$config$2f$env$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/frontend/src/config/env.ts [app-client] (ecmascript)");
;
async function loginWithEmail(email) {
    let res;
    try {
        res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$config$2f$env$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["config"].api.baseUrl}/auth/login`, {
            method: 'POST',
            headers: {
        ...
        throw new Error('Cannot reach server. Make sure the backend is running (e.g. node backend/server.js on port 5000).');
    }
...
async function getPoliciesByEmail(email, signal) {
    const out = await getJson(`${__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$config$2f$env$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["config"].api.baseUrl}/policies/email/${encodeURIComponent(email.trim())}`, signal);
    return out.data ?? [];
}
async function getClaimsByPolicyNumbers(policyNumbers, signal) {
    if (policyNumbers.length === 0) return [];
    const q = policyNumbers.map((p)=>encodeURIComponent(p)).join(',');
    const out = await getJson(`${__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$config$2f$env$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["config"].api.baseUrl}/claims?policyNumbers=${q}`, signal);
    return out.data ?? [];
}
async function getBillingByPolicyNumbers(policyNumbers, signal) {
    if (policyNumbers.length === 0) return [];
    const q = policyNumbers.map((p)=>encodeURIComponent(p)).join(',');
    const out = await getJson(`${__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$config$2f$env$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["config"].api.baseUrl}/billing?policyNumbers=${q}`, signal);
    return out.data ?? [];
}
async function sendPaymentEmail(data) {
    let res;
    try {
        res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$config$2f$env$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["config"].api.baseUrl}/billing/send-payment-email`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
async function createClaim(data) {
    let res;
    try {
        res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$config$2f$env$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["config"].api.baseUrl}/claims`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
async function createClaimWithImages(formData) {
    let res;
    try {
        res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$config$2f$env$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["config"].api.baseUrl}/claims`, {
            method: 'POST',
...
function AuthProvider({ children }) {
    ...
    const loadFromStorage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
    ...
    const login = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[login]": async (email)=>{
            setError(null);
            setState({
                "AuthProvider.useCallback[login]": (s)=>({
                        ...s,
                        isLoading: true
                    })
            }["AuthProvider.useCallback[login]"]);
            try {
                const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loginWithEmail"])(email);
    ...
    const logout = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[logout]": ()=>{
            if ("TURBOPACK compile-time truthy", 1) localStorage.removeItem(STORAGE_KEY);
            setState({
                user: null,
                token: null,
                isLoading: false,
...
_s(AuthProvider, "yfpM8PCwmYJncJyNxz8elsbMj2k=", false, function() {
    return [
...
"[project]/frontend/src/providers/Providers.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function Providers({ children }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$context$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AuthProvider"], {
        ...
        fileName: "[project]/frontend/src/providers/Providers.tsx",
        lineNumber: 6,
        columnNumber: 10
    }, this);
}
...
//# sourceMappingURL=frontend_9253bf70._.js.map